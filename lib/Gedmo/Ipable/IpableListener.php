...
/**
 * The Ipable listener handles the update of
 * dates on creation and update.
 *
 * @author Gediminas Morkevicius <gediminas.morkevicius@gmail.com>
 * @package Gedmo.Ipable
 * @subpackage IpableListener
 * @link http://www.gediminasm.org
 * @license MIT License (http://www.opensource.org/licenses/mit-license.php)
 */
class IpableListener extends MappedEventSubscriber
{
    /**
    ...
    /**
     * Looks for Ipable objects being updated
                ...
                if (isset($config['update'])) {
                    foreach ($config['update'] as $field) {
                        if (!isset($changeSet[$field])) { // let manual values
                            $needChanges = true;
                            $meta->getReflectionProperty($field)->setValue($object, $ea->getIPValue($meta, $field));
                        }
                    }
                }
                        ...
                        if (isset($changeSet[$tracked])) {
                            ...
                            if ($options['value'] == $value) {
                                ...
                                $meta->getReflectionProperty($options['field'])
                                    ->setValue($object, $ea->getIPValue($meta, $options['field']));
                            }
                        }
                    }
                }
    ...
    /**
     * Checks for persisted Ipable objects
